...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/video_objects.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.finetune.yaml', help='hyperparameters path, i.e. data/hyp.scratch.yaml')
    parser.add_argument('--epochs', type=int, default=300)
    parser.add_argument('--batch-size', type=int, default= 96, help='total batch size for all GPUs')
    parser.add_argument('--img-size', nargs='+', type=int, default=[135, 240], help='train,test sizes')
