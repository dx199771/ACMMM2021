...
from utils.video_datasets import create_dataloader
...
def get_id_from_video_name(video_name):
    return os.path.splitext(ntpath.basename(video_name))[0]
...
def main():
    ...
    parser.add_argument('--search-data', type=str, default='./v_data/videos', help='videos path of search data')
    ...
    # Test loaded cropped images
    '''
    figure = plt.figure(figsize=(12, 12))
    for i in range(0, 16):
        query_image = search_dataset.get_image(i)
    ...
    for i in range(count):
        ...
        video_id = get_id_from_video_name(search_item['video'])
